...
label second_beginning:
    ...
    narrator "Welcome to the story of Dante's ascent through Purgatory, as envisioned in Chapters 13 through 21 of the 'Purgatorio'."
...
label canto_17:
    ...
    menu:
        "Dante asked about misguided love":
            $ dante_insight += 2
